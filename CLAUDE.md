...
- **İçerik: 27 yayın + 1 bilinçli taslak; 12 pillar'ın hepsi dolu.** 30 sözlük terimi, 136 topic.
- **Ölçüm (yerel üretim build'i, lhci medyan/3 koşu):** Lighthouse 0.97/1/1/1, CLS ~0, LCP 2.0s, TBT 50ms. 147 birim + 53 E2E (axe dahil, çift tema) yeşil.
