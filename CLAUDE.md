...
- **AÇIK İŞ — beş tür hâlâ boş:** uygulama, laboratuvar, araç kartı, ölçüm, vaka, uyum. Arşivleri ve rotaları hazır. Kısıt: uygulama çalışan repo ister (yok), laboratuvar/ölçüm KENDİ ölçümümüzü ister (yapılmadı), vaka veri paylaşım izni ister. Araç kartı ve uyum dosyası birincil kaynaklardan üretilebilir — sıradaki iş bu.
